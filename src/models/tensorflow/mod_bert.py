...
class ModTFBertEmbeddings(tf.keras.layers.Layer):
...
@keras_serializable
class ModTFBertMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config: BertConfig, add_pooling_layer: bool = True, **kwargs):
        ...
        self.embeddings = ModTFBertEmbeddings(config, name="embeddings")
...
class ModTFBertModel(TFBertPreTrainedModel):
